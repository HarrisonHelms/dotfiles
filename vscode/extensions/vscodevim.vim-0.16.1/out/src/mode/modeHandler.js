    ...
    updateView(vimState, args = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.vimState.currentMode === mode_1.ModeName.SearchInProgressMode) {
                ...
                this.vimState.editor.revealRange(new vscode.Range(nextMatch, nextMatch), vscode.TextEditorRevealType.InCenterIfOutsideViewport);
            }
            else if (args.revealRange) {
                this.vimState.editor.revealRange(new vscode.Range(vimState.cursorPosition, vimState.cursorPosition), vscode.TextEditorRevealType.InCenterIfOutsideViewport);
            }
            // cursor style
